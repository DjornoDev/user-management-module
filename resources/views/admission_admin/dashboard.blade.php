...
@section('content')
    ...
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-2xl font-bold text-gray-800">User Management Dashboard Overview</h1>
        {{-- create a button to go back to dashboard --}}
        ...
        <div class="overflow-x-auto rounded-lg border border-gray-200">
            <table id="usersTable" class="min-w-full bg-white">
                ...
                <tbody id="userTableBody" class="divide-y divide-gray-200">
                    <!-- Ge-generate ng Javascript yung mga table rows - Alpine Js -->
                </tbody>
            </table>
        </div>
